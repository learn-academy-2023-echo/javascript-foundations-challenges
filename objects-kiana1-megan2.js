...
//     totalIng: function () {
//         return `The ingredients for a PB and Banana sandwhich are ${this.ingredients}.`
//     }
//   }
// //updated lunch object
// const newLunch = {
//     sentence: "The ingredients for a PB and Banana sandwich are bread, peanut butter, and banana."
// }

//   console.log(lunch.ingredients)
//   console.log(lunch.ingredients[2])
//   console.log(lunch.totalIng())
...
// const animalsName = animals.map((value) => {
//     return value.name
// })
// const animalAge = animals.filter((value) => value.age >= 10) 
// const animalSent = (array) => {
//     return array.map (value => `My ${value.type}'s name is ${value.name}. They are ${value.age} years old.`) 
// }
...
// console.log(animalSent(animals))
